...
templateExplorer.up=function(event){
  ...
  if(this.state.rect.w<10||this.state.rect.h<10){
    this.state.rect=null;$('#patchRect').style.display='none';$('#patchSize').textContent='Selection too small';return;
  }
...
buildNav();bindGlobal();sample();mount('channels');
})();
